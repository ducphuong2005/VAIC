...
export const getMiniGames=()=>get('/minigames',{auth:false});export const getLatestMiniGameResult=()=>get('/minigames/latest-result');export const getMiniGame=id=>get(`/minigames/${encodeURIComponent(id)}`,{auth:false});export const startMiniGame=id=>post(`/minigames/${encodeURIComponent(id)}/start`);
